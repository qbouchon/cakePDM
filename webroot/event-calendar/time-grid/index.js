...
/* packages/time-grid/src/Section.svelte generated by Svelte v4.1.1 */
...
function create_each_block$5(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = action_destroyer(setContent_action = setContent.call(null, div, /*time*/ ctx[9]));
				mounted = true;
			}
		},
		p(new_ctx, dirty) {
			...
			if (setContent_action && is_function(setContent_action.update) && dirty & /*$_times*/ 4) setContent_action.update.call(null, /*time*/ ctx[9]);
		},
		d(detaching) {
			if (detaching) {
				detach(div);
...
/* packages/time-grid/src/Body.svelte generated by Svelte v4.1.1 */
...
/* packages/time-grid/src/Event.svelte generated by Svelte v4.1.1 */
...
/* packages/time-grid/src/NowIndicator.svelte generated by Svelte v4.1.1 */
...
/* packages/time-grid/src/Day.svelte generated by Svelte v4.1.1 */
...
/* packages/time-grid/src/all-day/Event.svelte generated by Svelte v4.1.1 */
...
/* packages/time-grid/src/all-day/Day.svelte generated by Svelte v4.1.1 */
...
/* packages/time-grid/src/all-day/Week.svelte generated by Svelte v4.1.1 */
...
/* packages/time-grid/src/View.svelte generated by Svelte v4.1.1 */
...
function create_each_block_1(ctx) {
	...
	return {
		c() {
			div = element("div");
			attr(div, "class", div_class_value = "" + (/*$theme*/ ctx[0].day + " " + /*$theme*/ ctx[0].weekdays?.[/*date*/ ctx[8].getUTCDay()]));
		},
		m(target, anchor) {
			insert(target, div, anchor);

			if (!mounted) {
				dispose = action_destroyer(setContent_action = setContent.call(null, div, /*$_intlDayHeader*/ ctx[2].format(/*date*/ ctx[8])));
				mounted = true;
			}
		},
		p(new_ctx, dirty) {
			...
			if (dirty & /*$theme, $_viewDates*/ 3 && div_class_value !== (div_class_value = "" + (/*$theme*/ ctx[0].day + " " + /*$theme*/ ctx[0].weekdays?.[/*date*/ ctx[8].getUTCDay()]))) {
				attr(div, "class", div_class_value);
			}

			if (setContent_action && is_function(setContent_action.update) && dirty & /*$_intlDayHeader, $_viewDates*/ 6) setContent_action.update.call(null, /*$_intlDayHeader*/ ctx[2].format(/*date*/ ctx[8]));
		},
		d(detaching) {
			if (detaching) {
				detach(div);
...
function create_default_slot_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*$theme, $_viewDates, $_intlDayHeader*/ 7) {
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*$$scope, $_viewDates*/ 8194) {
				section_changes.$$scope = { dirty, ctx };
			}
...
// (31:0) {#each $_viewDates as date}
function create_each_block(ctx) {
	let day;
	let current;
	day = new Day$1({ props: { date: /*date*/ ctx[8] } });
	...
	return {
		...
		p(ctx, dirty) {
			const day_changes = {};
			if (dirty & /*$_viewDates*/ 2) day_changes.date = /*date*/ ctx[8];
			day.$set(day_changes);
		},
		i(local) {
			if (current) return;
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, $_viewDates, $theme, $_intlDayHeader*/ 8199) {
				section_changes.$$scope = { dirty, ctx };
			}
