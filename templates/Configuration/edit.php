        ...
        <div class="configuration form content">
            ...
            <fieldset>
                ...
                <?php
                     ...
                     echo $this->Form->control('home_picture',['type' => 'file', 'value' =>$configuration->home_picture, 'id'=>'rAddPicture', 'label' => 'Ajouter une image d\'entête (.png, .jpg, .jpeg)', 'accept' => 'image/*']);                   
                ?>
