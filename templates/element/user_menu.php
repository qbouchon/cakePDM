<!-- Menu utilisateur -->
                        ...
                        <?= $this->Html->link('<div class="sb-nav-link-icon"><i class="fa-regular fa-calendar-check"></i></div>Mes réservations', ['controller'=>'Reservations','action' => 'indexUser'], ['class' => 'nav-link', 'escape' => false]) ?>
