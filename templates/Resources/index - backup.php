...
<div class="container">
    <div class="resources index content">
        ...
        <div class="paginator">
            ...
            <?= $this->Paginator->prev('<', ['model' => 'unArchivedResources']) ?>
            <?= $this->Paginator->numbers(['model' => 'unArchivedResources']) ?>
            <?= $this->Paginator->next('>', ['model' => 'unArchivedResources']) ?>
        ...
        <div class="paginator">
            <ul class="pagination pagination-sm d-flex justify-content-center ">        
            <?= $this->Paginator->prev('<', ['model' => 'archivedResources']) ?>
            <?= $this->Paginator->numbers(['model' => 'archivedResources']) ?>
            <?= $this->Paginator->next('>', ['model' => 'archivedResources']) ?>
